/**
 *  Reset armed mode after 15 seconds
 *
 *  Copyright 2022 Michael Trombley
 *
 ...
 */
definition(
    name: "Wait 15 seconds then set new mode",
    namespace: "tromtez",
    author: "Michael Trombley",
    description: "Wait 15 seconds set new mode",
...
preferences {
	section("Wait 15 seconds then change to this mode") {
...
private takeActions() {
	runIn(15, setLocationMode(newMode))
}
